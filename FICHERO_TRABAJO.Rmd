...
packages = c("tidyverse","knitr",'readr','lubridate','dplyr','tidyr', 'ggplot2', 'GGally', 'car','e1071')
...
- Si quisiesemos comprar una casa en las calles a analizar y nos gustaria que no tuviese mucho ruido, cual o cuales serian las mejores.¿Y si en vez de ser una casa fuese una empresa?
...
Un analisis despues de realizar el data frame es que no existen valores para el mes de Julio.
```{r}
...
- Y si en vez de analizar los datos por mes los analizasemos por cada año que hay contenidos en los datos?
...
- Vamos a analizar el nivel sonoro continuo curante el mes de marzo de 2022 para ver cuánto y como aumenta durante el periodo de fallas.
